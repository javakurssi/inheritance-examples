...
public class Main {
    ...
    public static void main(String[] args) {
        Product corolla = new Vehicle("Toyota Corolla 2015", "V123", 15000.0, "Helsinki", "Used",
        ...
        Product apartment = new Apartment("Spacious 2-bedroom apartment", "A456", 250000.0, "Espoo", "New",
                java.time.LocalDate.of(2024, 6, 15), 300.0, 85.0, 2, 3, 2020,
                "Concrete", "Leppävaara", "Water and heating included");

        Product coffeeMug = new Product("Coffee mug", "P789", 12.99, "Tampere", "New",
                java.time.LocalDate.of(2024, 4, 10));

        List<Product> products = List.of(corolla, apartment, coffeeMug);
